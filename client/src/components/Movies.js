...
class Movies extends Component {
  ...
  state = {
    dvds: [
      {id: 7, title: "Yes Man", external_id: "tt1068680", year: "2008", backdrop_path: "/oe32Z6gfjeNldrEPQWIrW1IbSaF.jpg"},
      {id: 8, title: "Up", external_id: "tt1049413", year: "2009", backdrop_path: "/6fX7NF6IUJCTVssei7Shgl9J6LL.jpg"},
      {id: 9, title: "Avatar", external_id: "tt0499549", year: "2009", backdrop_path: "/aHcth2AXzZSjhX7JYh7ie73YVNc.jpg"},
    ],
    unwanted: [],
    keepers: [],
  };
              ...
              <div className="card">
                ...
                <div className="rounded-bottom text-center">
                  <ul className="list-unstyled list-inline font-small d-flex justify-content-around mt-3 mb-0">
                    <li className="list-inline-item pr-2"><a href="#" className="white-text">
                    ...
                    <li className="list-inline-item"><a href="#" className="white-text">
